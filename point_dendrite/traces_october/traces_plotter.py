...
C_ba, RT = load_data('clu',0, 'base')
C_hw, RT = load_data('clu',15, 'base')
C_df, RT = load_data('clu',0, 'freq')
C_wf, RT = load_data('clu',0, 'weight')
C_twf, RT = load_data('clu',0, 'weight_n_freq')
C_tw4, RT = load_data('clu',0, '4weight_n_4freq')
...
for i in range(10):
    ...
    ax50.plot(RT[:], C_tw4[i,:], color = 'grey', alpha = .3, linewidth = .5)
...
ax50.plot(RT[:], np.mean(C_tw4, axis = 0), color = 'teal', alpha = 1, linewidth = 1)
...
ax51.plot(RT[1200:1400], np.mean(C_tw4[:,1200:1400], axis = 0), color = 'tab:red', alpha = 1, linewidth = 1)
...
ax51.plot(RT[1200:1400], np.mean(C_tw4[:,200:400], axis = 0), color = 'tab:blue', alpha = 1, linewidth = 1)

ax00.set_title('Stim. orientation $0^\circ$ inhib.')
ax10.set_title('Stim. orientation $15^\circ$ inhib.')
ax20.set_title('Stim. orientation $0^\circ$ inhib. double frequency')
ax30.set_title('Stim. orientation $0^\circ$ inhib. double weight')
ax40.set_title('Stim. orientation $0^\circ$ inhib. double weight and double frequency')
ax50.set_title('Stim. orientation $0^\circ$ inhib. 4 times weight and 4 times frequency')
...
ax51.set(ylim =(-70,0), xlabel = 'Time (ms)')
...
ax50.set(ylim =(-70,0), xlabel = 'Time (ms)', ylabel = 'Vm (mV)')
ax20.legend(loc = 6)
...
fig.savefig('Comparison_GABA.png', dpi = 200)
