...
ax[0].set(xlabel = '$\Delta[ion](mMol)$', ylabel = 'Absolute change in potential (a. u.)', title = '$\Delta E_{ion}$ changes') 
ax[0].legend()
...
ax[2].set(xlabel = '$\Delta[ion](\mu Mol)$', ylabel = 'Absolute change in potential (a. u.)', title = '$\Delta E_{ion}$ changes') 
ax[2].legend()
ax[0].set_ylim(0,1.8)
ax[2].set_ylim(0,1.8)
