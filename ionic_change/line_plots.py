...
ax[0].plot(ori, 2*bin_1*dKo(1.5, .2), color = plt.cm.Reds(.9))
...
ax[0].plot(ori, np.ones_like(bin_1)*dKo(1.5, .2)  ,alpha = 1, color = plt.cm.Blues(.9))
...
ax[0].legend([1.1, 1.2, 1.5, 'Random', 'tmp', 'tmp'], title = '$R_2$')
