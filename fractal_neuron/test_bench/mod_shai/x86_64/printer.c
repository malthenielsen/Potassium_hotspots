...
#define nrn_init _nrn_init__printer
#define _nrn_initial _nrn_initial__printer
#define nrn_cur _nrn_cur__printer
#define _nrn_current _nrn_current__printer
#define nrn_jacob _nrn_jacob__printer
#define nrn_state _nrn_state__printer
#define _net_receive _net_receive__printer 
#define rates rates__printer 
#define states states__printer 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_printer", _hoc_setdata,
 "rates_printer", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define zTau zTau_printer
 double zTau = 1;
 ...
 "zTau_printer", "ms",
 "gSK_E2bar_printer", "S/cm2",
 "dek_printer", "mV",
 "ik_printer", "mA/cm2",
 "gSK_E2_printer", "S/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 printer /home/nordentoft/Documents/BS_neuron/Nassi_November/mod_shai/printer.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nordentoft/Documents/BS_neuron/Nassi_November/mod_shai/printer.mod";
static const char* nmodl_file_text = 
