...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 VecStim /home/nordentoft/Documents/BS_neuron/mod_shai/vecstim.mod\n");
...
{    _p = _pnt->_prop->param; _ppvar = _pnt->_prop->dparam;
 ...
 _tsav = t;   if (_lflag == 1. ) {*(_tqitem) = 0;}
 {
   if ( _lflag  == 1.0 ) {
     ...
     if ( index > 0.0 ) {
       artcell_net_send ( _tqitem, _args, _pnt, t +  delay + etime - t , 1.0 ) ;
       }
     }
   } }
...
{
 {
   ...
   element ( _threadargs_ ) ;
   if ( index > 0.0 ) {
     artcell_net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, t +  delay + etime - t , 1.0 ) ;
     }
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nordentoft/Documents/BS_neuron/mod_shai/vecstim.mod";
static const char* nmodl_file_text = 
