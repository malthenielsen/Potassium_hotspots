...
#define inmda _p[3]
#define inmda_columnindex 3
#define gnmda _p[4]
#define gnmda_columnindex 4
#define A _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 nmda /home/nordentoft/Documents/Potassium_and_dendrites/fractal_neuron/test_bench/mod_shai/NMDA_syn.mod\n");
...
{  double* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _tsav = t; {
   gmax = _args[0] ;
    ...
    double __state = A;
    double __primary = (A + gmax ) - __state;
 ...
 A = A + gmax  ;
    ...
    /* discon state adjustment for cnexp case (rate uses no local variable) */
    double __state = B;
    double __primary = (B + gmax ) - __state;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nordentoft/Documents/Potassium_and_dendrites/fractal_neuron/test_bench/mod_shai/NMDA_syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "//****************************//\n"
