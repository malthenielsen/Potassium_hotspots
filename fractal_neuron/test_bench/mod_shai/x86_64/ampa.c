...
#define synon _p[5]
#define synon_columnindex 5
#define DRon _p[6]
#define DRon_columnindex 6
#define DRoff _p[7]
#define DRoff_columnindex 7
#define _g _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GLU /home/nordentoft/Documents/Potassium_and_dendrites/fractal_neuron/test_bench/mod_shai/ampa.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 92 in file ampa.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/nordentoft/Documents/Potassium_and_dendrites/fractal_neuron/test_bench/mod_shai/ampa.mod";
static const char* nmodl_file_text = 
  ...
  "	Beta	= 0.4	(/ms)		: backward (unbinding) rate Until March 2010, then changed 0.15\n"
