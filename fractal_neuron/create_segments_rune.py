...
def create_soma(name):
    ...
    soma.insert('Ih')
    soma.insert('pas')
    soma.gIhbar_Ih = 0.0166454e-3
    soma.g_pas = 0.0273e-3
    soma.gImbar_Im = 0.022e-3
    soma.decay_CaDynamics_E2 = 294.679571#*2/3 
    soma.gamma_CaDynamics_E2 = 0.000509 
    soma.gCa_LVAstbar_Ca_LVAst = 0.01e-3
    soma.gCa_HVAbar_Ca_HVA = 0.2e-3
    soma.gSK_E2bar_SK_E2 = 2.61e-3
    soma.gSKv3_1bar_SKv3_1 =2.34e-3
    soma.gNaTs2_tbar_NaTs2_t = 12.5e-3 
    soma.e_pas = -70
    soma.cm = 1
    soma.diam = 30
    soma.L = 30
